...
exports.getDailyRecap = exports.getWeeklyRecap = void 0;
...
const getWeeklyRecap = async (req, res) => {
    try {
        ...
        const weekStartParam = req.params.weekStart || req.query.weekStart;
...
exports.getWeeklyRecap = getWeeklyRecap;
/**
...
const getDailyRecap = async (req, res) => {
    try {
        ...
        const menuItem = await prismaClient_1.default.menuItem.findFirst({
            where: {
                weekMenu: {
                    weekStart: weekDate,
                    isActive: true,
...
exports.getDailyRecap = getDailyRecap;
